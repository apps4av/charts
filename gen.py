...
os.system("gdal2tiles.py -t TAC --tilesize=512 --tiledriver=WEBP --tiledriver=WEBP --webp-quality=60 --exclude --webviewer=all -c MUAVLLC --no-kml --resume --processes 8 -z 0-11 -r near tac.vrt tiles/1")
